...
>(({ className, ...props }, ref) => (
  <TabsPrimitive.List
    ref={ref}
    className={cn(
      "flex h-10 w-fit items-start justify-start bg-muted text-muted-foreground",
      className
    )}
    {...props}
  />
